...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center h-screen'>
      ...
      <p className='max-w-130 mt-2 text-sm md:text-base mt-5'>Hotel Tarun Vitara Grand offers a blend of comfort and elegance, providing guests with a memorable stay experience. Conveniently located, it ensures easy access to key attractions and amenities.</p>
