            ...
            <div className='flex gap-4'>
              ...
              <div className='flex flex-col justify-between'>
                <p className='font-playfair text-lg'>
                  {booking.hotel.name}
                  <span className='block font-inter text-sm text-gray-500'>{booking.room.roomType}</span>
                </p>
                <div className='flex items-center gap-1 text-sm text-gray-500'>
                  <img src={assets.locationIcon} alt="loc-icon" className='w-4 h-4' />
                ...
                <p className='text-base text-black'>Total : ${booking.totalPrice}</p>
              </div>
            </div>
